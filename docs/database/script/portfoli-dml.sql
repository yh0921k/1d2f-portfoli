...
-- 회원 예제 데이터
INSERT INTO pf_members(member_no, id, pwd, name, post_no, basic_address, email, tel, sms_yn, email_yn) VALUES (1, 'yh0921k', PASSWORD('1111'), '김용희', '06611', '서울특별시 서초구 강남대로 459 (서초동, 백암빌딩)', 'yh0921k@gmail.com', '010-1234-5678', 1, 1);
INSERT INTO pf_members(id, pwd, name, email, tel, sms_yn, email_yn) VALUES ('moonsolid', PASSWORD('2222'), '문국태', 'moonsolid@naver.com', '010-9876-5432', 1, 1);
INSERT INTO pf_members(id, pwd, name, email, tel, sms_yn, email_yn) VALUES ('oreotaste', PASSWORD('3333'), '손영쿡', 'oreotaste@daum.net', '010-2345-6789', 1, 1);
INSERT INTO pf_members(id, pwd, name, post_no, basic_address, email, tel, sms_yn, email_yn) VALUES ('juljasong', PASSWORD('4444'), '윤리아', '06621', '서울특별시 서초구 서초대로74길 33(서초동, 비트빌)', 'juljasong@gmail.com', '010-4567-8901', 1, 1);
INSERT INTO pf_members(id, pwd, name, email, tel, sms_yn, email_yn) VALUES ('jeoneunhee', PASSWORD('5555'), '전은희', 'jeoneunhee@naber.com', '010-1234-5674', 1, 1);
INSERT INTO pf_members(id, pwd, name, post_no, basic_address, email, tel, sms_yn, email_yn) VALUES ('warple', PASSWORD('6666'), '노정진', '63091', '제주특별자치도 제주시 1100로 3198-13(노형동)', 'contact_us@warple.co.kr', '010-2754-3257', 1, 1);
INSERT INTO pf_members(id, pwd, name, post_no, basic_address, detail_address, email, tel, sms_yn, email_yn) VALUES ('baegopa', PASSWORD('7777'), '김홍준', '05544', '서울특별시 송파 구 위례성대로 2(방이동, 장은빌딩)', '2층', 'help@baegopa.com', '010-4312-6754', 1, 1);
INSERT INTO pf_members(id, pwd, name, post_no, basic_address, email, tel, sms_yn, email_yn) VALUES ('hmarket', PASSWORD('8888'), '광병진', '06236', '서울특별시 강남구 테헤란로(역삼 동, 강남파이낸스센터)', 'hmk_cs@corp.hmarket.co.kr', '010-4952-6589', 1, 1);
INSERT INTO pf_members(id, pwd, name, post_no, basic_address, detail_address,  email, tel, sms_yn, email_yn) VALUES ('mosinna', PASSWORD('9999'), '김정우', '06017', '서울특별시 남구 언주로174길 30(신사동, 로빈명품관)', '지하1층', 'help@mosinna.com', '010-2394-3958', 1, 1);
INSERT INTO pf_members(id, pwd, name, post_no, basic_address, detail_address, email, tel, sms_yn, email_yn) VALUES ('planningadd', PASSWORD('1010'), '김성수', '13637', '경기도 성남시 분당구 구미로9번길 10(구미동, 세종그랑시아II)', '1-230', 'planning1@naver.com', '010-4958-9068', 1, 1);
