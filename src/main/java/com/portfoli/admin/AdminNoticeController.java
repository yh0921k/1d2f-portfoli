...
public class AdminNoticeController {
  ...
  static Logger logger = LogManager.getLogger(AdminNoticeController.class);

  public AdminNoticeController() {
    AdminNoticeController.logger.debug("NoticeController 객체 생성!");
  }
  ...
  @RequestMapping("list")
  public void list(@ModelAttribute("notice") final Notice notice,
  ...
  @GetMapping("form")
  public void form(final Model model) throws Exception {
    model.addAttribute("list", noticeCategoryService.list());
  }

  @PostMapping("add")
  @Transactional
  public String add(final int noticeNumber, final String title, final String content,
  ...
  public void updateForm(final Notice notice, final Model model) throws Exception {
  ...
  @PostMapping("update")
  public String update(final int originalNoticeNumber, final Notice notice,
      @RequestParam("files") final MultipartFile[] files) throws Exception {
