		...
		<div class="row">
			...
			<nav class="nav-deep nav-deep-light mb-2">
				...
				<c:if test="${loginUser.type == '1'}">
					<h3 class="h3 pt-3 pb-3 m-0 d-none d-lg-block ml-3 text-dark"><a href="/portfoli/app/member/generalMypage" style="cursor:pointer; text-decoration: none;">My Page</a></h3>
				</c:if> 
				<c:if test="${loginUser.type == '2'}">
					<h3 class="h3 pt-3 pb-3 m-0 d-none d-lg-block ml-3 text-dark"><a href="/portfoli/app/member/companyMypage" style="cursor:pointer; text-decoration: none;">My Page</a></h3>
				</c:if>
				<!-- navigation -->
