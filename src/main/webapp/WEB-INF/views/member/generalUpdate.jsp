		...
		<div class="col-lg-8 mt--20">
			...
			<div class="col-14 col-sm-14 col-md-14 col-lg-11">
				<ul class="nav nav-tabs">
					<li class="nav-item"><a class="nav-link nav-link-remember active" data-toggle="tab" href="#tab_account">계정</a>
					</li>

					<li class="nav-item"><a class="nav-link nav-link-remember" data-toggle="tab" href="#tab_address">주소</a></li>
				...
				<div class="tab-content">
					...
					<div id="tab_account" class="tab-pane active">
						...
						<div class="p-4 shadow-xs border bt-0 mb-4 bg-white">
							<form method="post" action="updateDefaultInfo" novalidate class="bs-validate"
                            ...
                            --> <input name="photoFile" type="file" data-file-ext="jpg, png"
												data-file-max-size-kb-per-file="5000" data-file-ext-err-msg="Allowed:"
												...
												data-file-preview-img-cover="true" class="custom-file-input absolute-full"
									...
									<div class="col">
										...
										<div class="row">
											...
											<div class="col-12 col-sm-6 col-md-6">
												...
												<div class="form-label-group mb-3">
													<input required placeholder="id" id="id" name="id" type="text" class="form-control"
														value=${member.id}>
											...
											<div class="col-12 col-sm-6 col-md-6">
												...
												<div class="form-label-group mb-3">
													<input placeholder="tel" id="tel" name="tel" type="text" class="form-control"
														value=${member.tel}> <label for="tel">연락처</label>
												</div>
					...
					<c:if test="${empty member.provider}">
						<div class="p-4 shadow-xs rounded mb-4 bg-white">
							<a href="#user_edit_password" class="btn-toggle btn fs--14 btn-light collapsed" data-toggle="collapse"
								aria-expanded="false" onclick=""> <span class="group-icon float-start"> <i class="fi fi-arrow-down"></i>
									...
									<div class="row mt-3">
										...
										<div class="col-12 col-sm-6 col-md-6">
											<div class="input-group-over">
												...
												<a href="#" class="btn fs--12 btn-password-type-toggle" data-target="#currentPassword"> <span
														class="group-icon"> <i class="fi fi-eye m-0"></i> <i class="fi fi-close m-0"></i>
													</span>
												</a>
											</div>
										</div>
										...
										<div class="col-12 col-sm-6 col-md-6">
											...
											<div class="input-group-over">
												...
												<!-- `SOW : Form Advanced` plugin used -->
												<a href="#" class="btn fs--12 btn-password-type-toggle" data-target="#newPassword"> <span
														class="group-icon">
				...
				<form method="post" action="updateAddress">
					...
					<div class="col-12 col-sm-6 col-md-6">
						...
						<div class="input-group mb-3">
							<input readonly type="text" class="form-control" placeholder="우편번호" id="addr1" name="postNumber"
					...
					<div class="form-label-group mb-3 ml-3">
						<input readonly placeholder="basicAddress" id="addr2" name="basicAddress" type="text" class="form-control"
							value="${member.basicAddress}"> <label for="basicAddress">도로명
							주소</label>
					</div>

					<div class="form-label-group mb-3 ml-3">
						<input placeholder="detailAddress" id="add3" name="detailAddress" type="text" class="form-control"
		...
		<div class="row">
			...
			<div class="col">
				<form method="post" action="updateProfile">
					...
					<div class="form-label-group mb-3 ml-3">
						<input placeholder="final-education" type="text" class="form-control"> <label for="">학력</label>
					</div>
					...
					<div class="form-label-group input-group mb-3 ml-3">
						<input type="text" id="word" class="form-control" placeholder="school" aria-label="검색어를 입력해 주세요."
						...
						<div class="input-group-append">
							...
							<div class="dropdown-menu">
								<a class="dropdown-item" onclick="catSchool('초등학교')">초등학교</a> <a class="dropdown-item"
									onclick="catSchool('중학교')">중학교</a> <a class="dropdown-item" onclick="catSchool('고등학교')">고등학교</a><a
						...
						<table class="table" id="certsList">
							...
							<tbody id="certsList">
								<c:forEach items="${memberCerts}" var="cert">
									<tr>
										<td><input readonly type='text' class='form-control form-control-sm' name='name'
												value='${cert.certificate.name}'></td>
										<td><input required type='text' class='form-control form-control-sm' name='issueDate'
												value='${cert.issueDate}' /></td>
										<td><input type='text' class='form-control form-control-sm' name='expireDate'
