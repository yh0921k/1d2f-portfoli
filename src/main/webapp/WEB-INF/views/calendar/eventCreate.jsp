...
<div class="modal-header">
    ...
    <div class="modal-body p--30">
      ...
      <!-- <form class="bs-validate" novalidate action="../../html_frontend/demo.files/php/demo.ajax_request.php" method="POST"> -->
      <form class="bs-validate js-ajax" novalidate method="post" action="#" method="POST" 
        ...
        <button type="submit" class="btn-fullcalendar-add btn btn-primary btn-soft btn-block">
          Create Event
        </button>
