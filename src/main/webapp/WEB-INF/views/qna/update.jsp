					...
					<div class="row">
						...
						<div class="custom-control custom-checkbox mt-3 ml--30">
							<c:if test="${qna.emailNoti == '1'}">
								<input type="checkbox" class="custom-control-input" id="emailNoti" name="emailNoti" checked>
							</c:if>
							<c:if test="${qna.emailNoti == '0'}">
								<input type="checkbox" class="custom-control-input" id="emailNoti" name="emailNoti">
							</c:if>
							<label class="custom-control-label" for="emailNoti">답변 완료 시 이메일 발송</label>
						</div>
					</div>
