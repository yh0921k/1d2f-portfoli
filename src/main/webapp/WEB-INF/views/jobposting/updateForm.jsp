...
>${jobPosting.content}</textarea>


    <div class="col-sm-13">
    최소경력* <input id="minimumCareer" placeholder="최소경력(숫자만 입력가능)"
        name='minimumCareer' type='number' class="form-control" value='${jobPosting.minimumCareer}'><br>
    </div>
  ...
  <br>
  시작일* <input id="startDated" autocomplete="off" placeholder="시작일" type='text' name='startDated'
   class="form-control datepicker"
   value='${jobPosting.startDated}' 
...
<br>
마감일* <input id="endDated" autocomplete="off" placeholder="마감일" type='text' name='endDated'
 class="form-control datepicker" 
 value='${jobPosting.endDated}'
 data-today-highlight="true" 
 data-layout-rounded="false" 
 data-title="마감일" 
 data-show-weeks="true" 
