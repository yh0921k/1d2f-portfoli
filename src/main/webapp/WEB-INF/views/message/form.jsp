...
<form novalidate class="bs-validate js-ajax"
  ...
  data-error-toast-text="<i class='fi fi-circle-spin fi-spin float-start'></i> 제목과 내용을 입력해주세요."
  ...
  <div class="modal-body p--30">
    ...
    <div class="form-label-group mb-3 mt-3">
      <input type="text" value="${loginUser.id}" readOnly
        class="form-control"> <label for="message_subject">보내는 사람</label>
    </div>
     -->
    <div class="form-label-group mb-3 mt-3">
    ...
    <div class="bg-light border border-dashed rounded p--15 clearfix">
      <div class="clearfix">
        ...
        <label
          ...
          <input name="messageFiles[]" multiple="multiple" type="file"
