  ...
  <div class="row">
    ...
    <div class="col-lg-3 mb-5 h--600 border-right ml--20 mt--20">
      ...
      <nav class="nav-deep nav-deep-light mb-2">
        ...
        <a href="/portfoli/app/member/companyMypage"
          style="cursor: pointer; text-decoration: none;"><h3
            class="h3 pt-3 pb-3 m-0 d-none d-lg-block ml-3 text-dark">My Page</h3></a>
        <!-- navigation -->
        <ul id="nav_responsive"
          ...
          <li class="nav-item font-weight-bold"><a class="nav-link"
            href="#"> <span class="group-icon"><i
                class="fi fi-arrow-end"></i><i class="fi fi-arrow-down"></i></span> <span
              class="px-2 d-inline-block font-weight-bold"> 쪽지함 </span>
          </a>
    ...
    <div class="col-lg-8 mt--20" data-gfont="Nanum Gothic">
      ...
      <div class="col-12 col-lg-9 col-xl-10 position-relative">
        <c:if test="${empty payments}"> <div class="pt-3 ml-3"> 구매 내역이 존재하지 않습니다. </div></c:if>
        <c:forEach items="${payments}" var="payment">
          <div class="card h-100 border-light bl-0 br-0 bb-0 bw--2">
            <div class="card-body">
              <h5 id="date" class="card-title"> ${payment.payDate}
                &nbsp; <small class="text-muted"> (주문번호: ${payment.number}) </small>
              </h5>
              ...
              <p>
                <small><span style="color: #263238; font-weight: bold;"> ${payment.jobPostingTitle} </span>
                  <br> 사용 기간 : ${payment.startDate} ~ ${payment.endDate} <br>
                  결제 수단 : ${payment.method} <br> 승인 내역 : ${payment.comment}
                </small>
              </p>
            </div>
          </div>
        ...
        <div class="col-12 col-xl-6 d-middle">
          <nav aria-label="pagination">
            <ul
              ...
              <c:if test="${empty payments}">style="visibility:hidden;"</c:if>>
