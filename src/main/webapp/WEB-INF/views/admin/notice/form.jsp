    ...
    <form action="add" method="post" enctype="multipart/form-data">
      ...
      <div class="container-fluid">
        ...
        <div align="right" class="container-fluid">
          <button type="submit"
            class="btn btn-outline-secondary btn-pill btn-sm mt-3">등록하기</button>
          <button class="btn btn-outline-secondary btn-pill btn-sm mt-3" onclick="move(event)">취소</button>
        </div>
      </div>
    </form>
  </section>
