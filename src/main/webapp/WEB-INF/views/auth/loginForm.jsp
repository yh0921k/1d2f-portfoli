...
<meta name="google-signin-client_id" content="918378045290-rmpud779f5h155ifo0mrvj08edqtqdt2.apps.googleusercontent.com">
</head>

<body>
	<div id="wrapper">
		<!-- light logo -->
		<a aria-label="go back" href="/portfoli" class="position-absolute top-0 start-0 my-2 mx-4 z-index-3 h--70 d-inline-flex align-items-center">
			<img src="../../resources/assets/images/logo/logo.png" width="110" alt="..." />
		</a>
		...
		<div class="d-lg-flex text-white min-h-100vh"
			...
			<div class="col-12 col-lg-5 d-lg-flex">
				<div class="w-100 align-self-center">
					<div class="py-7">
						...
						Sign in 
						<span class="display-3 h1-xs d-block font-weight-medium"> Portfoli </span>
						</h1>
					</div>
				</div>
			</div>
			...
			<div class="col-12 col-lg-7 d-lg-flex">
				<div class="w-100 align-self-center text-center-md text-center-xs py-2">
					...
					<form action="login" method="POST" class="bs-validate p-5 py-6 rounded d-inline-block bg-white text-dark w-100 max-w-600">
						<div class="row" style="margin: 0px 0px 20px 0px;">
							...
							<div class="col-6 mb-1">
								<div class="btn btn-sm btn-block bg-googleplay transition-hover-top text-white" onclick="google();">
									<i>G</i> google
								</div>
							</div>
							...
							<div class="col-6">
								<a href="${naverApiURL}"> 
								<img class="transition-hover-top" width="240" height="42" src="../../resources/assets/images/naver_green.PNG" />
								</a>
							</div>

              <div class="col-6">
							<a href="https://github.com/login/oauth/authorize?scope=user&client_id=74e05c13d93fb5feacb1" class="btn btn-sm btn-block btn-github transition-hover-top text-white">
						...
						<div class="form-label-group mb-3">
							<input required placeholder="Email" name="email" type="text"
								...
								style="color: graytext; margin: 10px 0px 0px 0px;" checked /> 아이디 저장해두기 <br/>
						</div>

						<div class="input-group-over">
							<div class="form-label-group mb-3">
								<input required placeholder="Password" name="password" type="password" class="form-control" /> <label for="account_password">비밀번호를 입력해주세요</label>
							</div>
						...
						<div class="row">
							<div class="col-12 col-md-6 mt-4">
								<button type="submit" class="btn btn-primary btn-block transition-hover-top"> 로그인</button>
							</div>
