		...
		<div class="row">
					...
					<ul id="nav_responsive"
						...
						<li class="nav-item font-weight-bold"><a class="nav-link"
							...
							<ul class="nav flex-column px-2 font-weight-bold">
								...
								<li class="nav-item"><a class="nav-link"
									href="/portfoli/app/message/received"> 받은 쪽지함 </a></li>
							</ul></li>
			...
			<div class="col-lg-8">
				...
				<form novalidate class="bs-validate d-block mb-7" method="post"
					action="/portfoli/app/member/updatePic" enctype="multipart/form-data">
							...
							<div class="portlet">
								...
								<div class="portlet-body">
									...
									<div class="row h-100 d-flex align-items-center">
										...
										<a class="btn btn-ghost btn-dark btn-pill mb-1 btn-sm" href="#" role="button" style="font-size: 13px">구직중</a>
										</c:if>
										<c:if test="${loginUser.seekingFlag =='0'}">
										<a class="btn btn-outline-dark btn-pill mb-1 btn-sm" href="#" role="button" style="font-size: 13px">재직중</a>
                    </c:if>
                    </p>
										<p>${loginUser.email}</p>
