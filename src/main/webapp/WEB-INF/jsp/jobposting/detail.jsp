...
<img src="${pageContext.servletContext.contextPath}/upload/jobposting/${jobPostingFile.filePath}"
...
<a href='updateForm?no=${jobPosting.jobPostingNumber}' class="btn btn-outline-dark btn-pill mb-1">수정</a>
</div>
<div style="text-align:right">
