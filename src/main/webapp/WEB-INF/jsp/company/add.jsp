        ...
        <div class="container">
          ...
          <div class="row">
            ...
            <div class="col-12 col-sm-8 col-md-8 col-lg-6 offset-sm-2 offset-md-2 offset-lg-3">
              ...
              <form class="bs-validate p-5 rounded shadow-xs" novalidate method="post" action="add" 
                ...
                <div class="form-label-group mb-3">
                  <input required placeholder="사업자등록번호" readonly name="businessRegistrationNumber" type="text" class="form-control" value="${businessRegistrationNumber}"/>
                  <label for="businessRegistrationNumber">사업자등록번호</label>
                </div>

                <div class="form-label-group mb-3">
                  <input required placeholder="기업명" id="name" name="name" type="text" class="form-control">
                  <label for="name">기업명</label>
                </div>

                <div class="form-label-group mb-3">
                  <input required placeholder="기업 전화번호" id="tel" name="tel" type="text" class="form-control">
                  <label for="account_email">기업 전화번호</label>
                </div>

                <div class="form-label-group mb-3">
                  <input placeholder="대표자" id="representative" name="representative" type="text" class="form-control">
