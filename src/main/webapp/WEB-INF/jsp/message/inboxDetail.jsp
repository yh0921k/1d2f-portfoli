      ...
      <div
        ...
        <span data-id="0" data-file-name="${messageFile.fileName}"
          ...
          class="js-file-input-preview-footer text-white position-absolute w-100 bottom-0 left-0 right-0 clearfix overlay-dark overlay-opacity-2">
            ...
            <img width="150" height="100" src="${pageContext.servletContext.contextPath}/upload/message/${messageFile.filePath}">
        </span>
      </div>
    </c:forEach>
  </div>
...
<div class="clearfix container py-3 row-pill rounded mt-1">
  <div class="float-end">
    <a
      href="/portfoli/app/message/form?receiverNumber=${message.senderNumber}"
      ...
      <i class="fi fi-arrow-right-3"></i> 답장하기 </a>
      <a href="#!"
