			...
			<ul id="nav_responsive"
				...
				<li class="nav-item font-weight-bold active"><a
					...
					<ul class="nav flex-column px-2 font-weight-bold">
						...
						<li class="nav-item font-weight-bold active"><a
							class="nav-link" href="/portfoli/app/message/sent"> 보낸 쪽지함 </a></li>
					</ul></li>
									...
									<c:forEach items="${sent}" var="message">
										...
										<tr id="message_id_1" class="text-dark">
											...
											<td><a href="message-detail.html"
												class="font-weight-medium text-muted mx-2 m-0-xs">${message.title}</a></td>

											<td class="hidden-lg-down"><span
												class="d-block text-muted">${message.member.id}</span></td>

											<td class="hidden-lg-down"><span
												class="d-block text-muted">${message.sendDate}</span></td>
