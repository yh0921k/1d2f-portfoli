...
<div class="row gutters-sm">
      ...
      <div
        class="col-lg-3 mb-5 h--600 border-right ml--20">
								...
								<tr id="message_id_1" class="text-dark">
									...
									<td class="hidden-lg-down"><label
										class="form-checkbox form-checkbox-secondary float-start">
											<input type="checkbox" name="item_id[]" value="1"> <i></i>
									</label></td>

									<td><span class="d-block font-weight-medium"><a href="message-detail.html"
										class="font-weight-medium text-muted mx-2 m-0-xs">${item.title}</a></span></td>

									<td class="hidden-lg-down"><span class="d-block text-muted">${item.member.id}</span></td>

									<td class="hidden-lg-down"><span class="d-block text-muted">${item.sendDate}</span></td>
										...
										<div class="dropdown">
											...
											<a href="#" class="btn btn-sm btn-light rounded-circle"
												...
												aria-haspopup="true"> <span class="group-icon"> <i
													class="fi fi-dots-vertical-full"></i> <i
													class="fi fi-close"></i>
											</span>
											</a>
											...
											<div
												...
												<a class="dropdown-item text-truncate"
													...
													class="fi fi-arrow-right-3"></i> 답변
												</a> <a href="#!"
