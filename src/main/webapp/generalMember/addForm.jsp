...
<html lang="ko" xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <link
      rel="preload"
      href="../../resources/assets/fonts/flaticon/Flaticon.woff2"
      as="font"
      type="font/woff2"
      crossorigin
    />
  ...
  <body>
    <div id="wrapper">
      ...
      <div
        class="d-lg-flex text-white min-h-100vh"
            ...
            >
              ...
              <div class="form-label-group mb-3">
                <input
                  ...
                  onchange="isSame()"
                />
                <label for="account_password">비밀번호 확인</label>
                <span id="same"></span>
              </div>
              ...
              <div class="form-label-group mb-3">
                <input
                  ...
                  class="form-control"
                />
                <label for="account_id">연락처</label>
              </div>
              ...
              <div class="form-label-group mb-3">
                <input
                  ...
                  class="form-control"
                />
                <label for="account_career">경력(년)</label>
              </div>

              <div class="clearfix bg-light position-relative rounded p-4 mb-4">
                <span class="text-muted fs--15 d-block m-2">
                  🖊 portfoli에서 보내는 이메일 및 SMS 수신에 동의하십니까?<br />
                  등록한 관심 채용 공고와 일정을 받아보실 수 있습니다!
                </span>
